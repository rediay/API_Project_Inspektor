...
{
    public abstract class BaseDocumentRepository<TType, TContext>
        where TType : BaseEntity, new()
        where TContext : DataDocumentsContext
    {
        private readonly TContext _dbContext;
        private DataContext context;

        protected BaseDocumentRepository(TContext context)
        {
            _dbContext = context;
           
        }

        protected BaseDocumentRepository(DataContext context)
        {
