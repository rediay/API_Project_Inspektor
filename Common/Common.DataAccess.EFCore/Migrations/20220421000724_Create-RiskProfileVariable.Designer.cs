...
namespace Common.DataAccess.EFCore.Migrations
{
    ...
    [Migration("20220421000724_Create-RiskProfileVariable")]
    partial class CreateRiskProfileVariable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Common.Entities.CategoryVariable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("RiskProfileVariableId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RiskProfileVariableId");

                    b.ToTable("CategoryVariables", "starter_core");
                });
            ...
            modelBuilder.Entity("Common.Entities.EventRoiOperationStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("EventRoiOperationStatuses", "starter_core");
                });

            modelBuilder.Entity("Common.Entities.EventRoiOperationType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("EventRoiOperationTypes", "starter_core");
                });
            ...
            modelBuilder.Entity("Common.Entities.NewsCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Common.Entities.NewsStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Common.Entities.NewsType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Common.Entities.RiskProfileVariable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("riskProfileVariables", "starter_core");
                });
            ...
            modelBuilder.Entity("Common.Entities.CategoryVariable", b =>
                {
                    b.HasOne("Common.Entities.RiskProfileVariable", "RiskProfileVariable")
                        .WithMany("CategoryVariables")
                        .HasForeignKey("RiskProfileVariableId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("RiskProfileVariable");
                });
            ...
            modelBuilder.Entity("Common.Entities.EventRoi", b =>
                {
                    b.HasOne("Common.Entities.EventRoiOperationStatus", "OperationStatus")
                        .WithMany()
                        .HasForeignKey("OperationStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Common.Entities.EventRoiOperationType", "OperationType")
                        .WithMany()
            ...
            modelBuilder.Entity("Common.Entities.News", b =>
                {
                    b.HasOne("Common.Entities.NewsCategory", "NewCategory")
                        .WithMany()
                        .HasForeignKey("NewCategoryId");

                    b.HasOne("Common.Entities.NewsStatus", "NewStatus")
                        .WithMany()
                        .HasForeignKey("NewStatusId");

                    b.HasOne("Common.Entities.NewsType", "NewType")
                        .WithMany()
            ...
            modelBuilder.Entity("Common.Entities.RiskProfileVariable", b =>
                {
                    b.Navigation("CategoryVariables");
                });
