...
namespace Common.WebApiCore.Identity
{
        ...
        where TUser : Entities.User, new()
    {
        ...
        public AuthenticationService(JwtManage jwtManager, UserManager<TUser> userManager)
        {
        ...
        public async Task<bool> AddPassword(string email)
        {
            ...
            await userManager.AddPasswordAsync(user, hashedNewPassword);
